...
if __name__ == '__main__':
    ...
    xml_df.to_csv('geometry_labels_val_new.csv', index=None, header=False)
    
    xml_df = xml_to_csv(parser.annotated_path, train_annos_ids, use_hash=True)
    xml_df.to_csv('geometry_labels_new.csv', index=None, header=False)
