...
def run(_):
  ...
  problem_text = _PROBLEM.value

  # Xử lý nội dung đề bài để tạo this_problem
  # Ví dụ: Tạo một đối tượng bài toán từ đoạn văn bản đề bài
  this_problem = pr.Problem.from_txt(data=problem_text, translate=need_rename)
